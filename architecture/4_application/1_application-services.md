...
flowchart LR
  ...
  s1(["⚙ «Application Service» Metamodel management [ASVC1]"]):::application
  s2(["⚙ «Application Service» Element browsing and editing [ASVC2]"]):::application
  s3(["⚙ «Application Service» CSV ingestion [ASVC3]"]):::application
  s5(["⚙ «Application Service» Grounded question answering [ASVC5]"]):::application
  s7(["⚙ «Application Service» Branches and merge [ASVC7]"]):::application
  s8(["⚙ «Application Service» Target state [ASVC8]"]):::application
  s9(["⚙ «Application Service» Propose [ASVC9]"]):::application
  s10(["⚙ «Application Service» Model health [ASVC10]"]):::application
  reader --> s2
  reader --> s5
  reader --> s8
  reader --> s10
...
flowchart TB
  ...
  s2(["⚙ «Application Service» Element browsing and editing [ASVC2]"]):::application
  s3(["⚙ «Application Service» CSV ingestion [ASVC3]"]):::application
  s4(["⚙ «Application Service» Graph query [ASVC4]"]):::application
  s5(["⚙ «Application Service» Grounded question answering [ASVC5]"]):::application
  s6(["⚙ «Application Service» Architecture views [ASVC6]"]):::application
  s7(["⚙ «Application Service» Branches and merge [ASVC7]"]):::application
  s8(["⚙ «Application Service» Target state [ASVC8]"]):::application
  s9(["⚙ «Application Service» Propose [ASVC9]"]):::application
  s10(["⚙ «Application Service» Model health [ASVC10]"]):::application
...
flowchart LR
  ...
  s9(["⚙ «Application Service» Propose [ASVC9]"]):::application
  s10(["⚙ «Application Service» Model health [ASVC10]"]):::application
  c1["▭ «Application Component» Metamodel registry [ACMP1]"]:::application
  c3["▭ «Application Component» Repository and graph services [ACMP3]"]:::application
  c5["▭ «Application Component» Agent [ACMP5]"]:::application
  c9["▭ «Application Component» Branch overlay and merge [ACMP9]"]:::application
  c10["▭ «Application Component» Proposal agent [ACMP10]"]:::application
  c11["▭ «Application Component» Health and search services [ACMP11]"]:::application
  c12["▭ «Application Component» Roles and review [ACMP12]"]:::application
  s1 -->|realized by| c1
  s2 -->|realized by| c3
  s4 -->|realized by| c3
  s5 -->|realized by| c5
